...
function parseRules(rules) {
  try {
    ...
    for (let rule of rulesTmp) {
      ...
      let value = Number.parseInt($(rule).find(".value").val());
...
function addNewAtrRule(id, type) {
  $("#" + type + "Rules>ul").append('<li class="' + type + '-atr" id="' + id + '">' + '<span class="bold">Rule: </span>On ' + '<div id="' + id + 'TF" class="inline" style=""><div class="drop-down"><a href="#/" onclick="dropDown(\'#' + id + 'TF\')"><span class="name timeframe">' + lastTFUsed + '</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="tfDropDownItem(\'1 minute\', \'#' + id + "TF')\">1 minute</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('5 minutes', '#" + id + "TF')\">5 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('15 minutes','#" + id + "TF')\">15 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('30 minutes', '#" + id + "TF')\">30 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('1 hour', '#" + id + "TF')\">1 hour</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('2 hours', '#" + id + "TF')\">2 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('4 hours', '#" + id + "TF')\">4 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('12 hours', '#" + id + "TF')\">12 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('1 day', '#" + id + "TF')\">1 day</a></li></ul></div></div>" + " timeframe the price is " + '<div class="drop-down">' + '<a href="#/" onclick="dropDown(\'#' + id + '\')"><span class="name direction">above</span> <span ' + 'class="caret"></span></a>' + "<ul>" + "<li><a href=\"#/\" onclick=\"dropDownItem('above', '#" + id + "', function(){ $('#" + id + "P').show();$('#" + id + "C').hide()})\">above</a></li>" + "<li><a href=\"#/\" onclick=\"dropDownItem('below', '#" + id + "', function(){ $('#" + id + "P').show();$('#" + id + "C').hide()})\">below</a></li>" + "<li><a href=\"#/\" onclick=\"dropDownItem('crossing', '#" + id + "', function(){ $('#" + id + "C').show();$('#" + id + "P').hide()})\">crossing</a></li>" + "</ul>" + "</div>" + '&nbsp;Average True Range with period <input class="period" type="number" value="20" /> ' + '<div id="' + id + 'P" class="inline"> by <input class="value" type="number" value="10" /> %</div>' + '<div id="' + id + 'C" class="inline" style="display:none;"> from ' + '<div class="drop-down">' + '<a href="#/" onclick="dropDown(\'#' + id + 'C\')"><span class="name cross-direction">bottom to top</span> <span ' + 'class="caret"></span></a>' + "<ul>" + "<li><a href=\"#/\" onclick=\"dropDownItem('bottom to top', '#" + id + "C')\">bottom to top</a></li>" + "<li><a href=\"#/\" onclick=\"dropDownItem('top to bottom', '#" + id + "C')\">top to bottom</a></li>" + "</ul>" + "</div>" + "</div>" + '&nbsp;<a title="Info" onclick="smaInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' + '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' + id + '\')" href="#/"><i class="text-red fas fa-times"></i></a>' + "</li>");
}
...
function ttargetInfo() {
  openModalInfoBig('<div style="display:inline-block;width:40%;margin:0 5%"><h3 class="text-center">Trailing Target</h3><br>This option will place a trailing stoploss bellow the current price after given target is reached first.<br> ' + "<br>For example: <br>1. Buy at $100 with target 10% and trailing target 1%.<br>2. When the price reaches the 10% target at $110 a trailing stoploss will be placed at 108.9 (1% bellow the curent price)." + "<br>3. The price continue going up along with the trailing stop.<br>4. Finally after reaching $117.5 the price drops more than 1% and the stop closes the trade at $116." + "<br>5. So you made $16 per coin instead of $10 (the initial target)" + '</div><img style="display:inline-block;width:40%;margin:0 5%;vertical-align:top;" src="./assets/images/ttarget-info.png" alt="">');
}
...
function fillRule(rule, id) {
  ...
  if (rule.indicator === "sma" || rule.indicator === "ema") {
    ...
    $(id).find(".direction").text(
      rule.direction === "bellow"
      ? "below"
      : rule.direction);
