  ...
  try {
    ...
    for (let rule of rulesTmp) {
      ...
      let direction = $(rule)
        .find(".direction")
        .text();
      let period = Number.parseInt(
        $(rule)
          .find(".period")
          .val()
      );
      let period2 = Number.parseInt(
        $(rule)
          .find(".period2")
          .val()
      );
      ...
      let crossDirection = $(rule)
        .find(".cross-direction")
        .text();
      let timeframe = $(rule)
        .find(".timeframe")
        .text();
      ...
      if (indicator === "sma" || indicator === "ema") {
        ...
        let indicatorName = indicator === "stoRsi" ? "Stochastic RSI" : "Stochastic";
  ...
  try {
    ...
    if (isRunnig) {
      openModalInfo(
        'Strategy with name "' +
          strategy.name +
          '" already exists and is currently running.<br>Please stop the execution and then try to edit/remove it.'
      );
      return;
    }
    ...
    if (hasOpenTrades) {
      openModalInfo(
        "Edit is not allowed for executing strategies with open trades.<br>If you want to edit, please close the trade."
      );
      return;
    }
    if (hasOpenTrades2) {
    ...
    if (srtTmp !== null && orgStrategyName !== srtTmp.name) {
      let label = isUsedInExecutions
        ? "Strategy with name " +
          strategy.name +
          ' already exists and is also in the "Executions" list. Your changes will apply to the execution as well. <br>Do you want to overwrite it?'
...
function addNewSmaRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      type +
      '-sma" id="' +
      id +
      '">' +
      '<span class="bold">Rule: </span>On ' +
      '<div id="' +
      id +
      'TF" class="inline" style=""><div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'TF\')"><span class="name timeframe">' +
      lastTFUsed +
      '</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="tfDropDownItem(\'1 minute\', \'#' +
      id +
      "TF')\">1 minute</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('5 minutes', '#" +
      id +
      "TF')\">5 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('15 minutes','#" +
      id +
      "TF')\">15 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('30 minutes', '#" +
      id +
      "TF')\">30 minutes</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('1 hour', '#" +
      id +
      "TF')\">1 hour</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('2 hours', '#" +
      id +
      "TF')\">2 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('4 hours', '#" +
      id +
      "TF')\">4 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('12 hours', '#" +
      id +
      "TF')\">12 hours</a></li><li><a href=\"#/\" onclick=\"tfDropDownItem('1 day', '#" +
      id +
      "TF')\">1 day</a></li></ul></div></div>" +
      " timeframe the price is " +
      '<div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      '\')"><span class="name direction">above</span> <span ' +
      'class="caret"></span></a>' +
      "<ul>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('above', '#" +
      id +
      "', function(){ $('#" +
      id +
      "P').show();$('#" +
      id +
      "C').hide()})\">above</a></li>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('below', '#" +
      id +
      "', function(){ $('#" +
      id +
      "P').show();$('#" +
      id +
      "C').hide()})\">below</a></li>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('crossing', '#" +
      id +
      "', function(){ $('#" +
      id +
      "C').show();$('#" +
      id +
      "P').hide()})\">crossing</a></li>" +
      "</ul>" +
      "</div>" +
      '&nbsp;SMA with period <input class="period" type="number" value="20" /> ' +
      '<div id="' +
      id +
      'P" class="inline"> by <input class="value" type="number" value="10" /> %</div>' +
      '<div id="' +
      id +
      'C" class="inline" style="display:none;"> from ' +
      '<div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      'C\')"><span class="name cross-direction">bottom to top</span> <span ' +
      'class="caret"></span></a>' +
      "<ul>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('bottom to top', '#" +
      id +
      "C')\">bottom to top</a></li>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('top to bottom', '#" +
      id +
      "C')\">top to bottom</a></li>" +
      "</ul>" +
      "</div>" +
      "</div>" +
      '&nbsp;<a title="Info" onclick="smaInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
  );
}
...
function addNewEmaRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      "</ul>" +
      "</div>" +
      '&nbsp;EMA with period <input class="period" type="number" value="20" /> ' +
      '<div id="' +
      id +
      'P" class="inline"> by <input class="value" type="number" value="10" /> %</div>' +
      '<div id="' +
      ...
      "</div>" +
      "</div>" +
      '&nbsp;<a title="Info" onclick="emaInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function addNewCmaRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      ' timeframe <div id="' +
      id +
      'T1" class="inline"><div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'T1\')"><span class="name ma-type">SMA</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'SMA\', \'#' +
      id +
      "T1')\">SMA</a></li><li><a href=\"#/\" onclick=\"dropDownItem('EMA', '#" +
      id +
      'T1\')">EMA</a></li></ul></div></div> with period <input class="period" type="number" value="20"> is crossing <div id="' +
      id +
      'T2" class="inline"><div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'T2\')"><span class="name ma-type2">SMA</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'SMA\', \'#' +
      id +
      "T2')\">SMA</a></li><li><a href=\"#/\" onclick=\"dropDownItem('EMA', '#" +
      id +
      'T2\')">EMA</a></li></ul></div></div> with period <input class="period2" type="number" value="50" />' +
      '<div id="' +
      id +
      'C" class="inline"> from ' +
      '<div class="drop-down">' +
      ...
      "</div>" +
      "</div>" +
      '&nbsp;<a title="Info" onclick="cmaInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function addNewRsiRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      id +
      "TF')\">1 day</a></li></ul></div></div>" +
      ' timeframe RSI with period <input class="period" type="number" value="14" /> is&nbsp;' +
      '<div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      '\')"><span class="name direction">above</span> <span ' +
      ...
      "', function(){ $('#" +
      id +
      "C').show()})\">crossing</a></li>" +
      "</ul>" +
      "</div>" +
      '<div class="inline">&nbsp;<input class="value" type="number" value="50"/></div>' +
      '<div id="' +
      id +
      'C" class="inline" style="display:none;"> from ' +
      '<div class="drop-down">' +
      ...
      "</div>" +
      "</div>" +
      '&nbsp;<a title="Info" onclick="rsiInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function addNewMacdRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      id +
      "TF')\">1 day</a></li></ul></div></div>" +
      ' timeframe MACD, using "fast" period <input class="period" type="number" value="12" /> and "slow" period <input class="period2" type="number" value="26"/>,&nbsp;is&nbsp;<div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      '\')"><span class="name direction">above</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'above\', \'#' +
      id +
      "', function(){ $('#" +
      id +
      "P').show();$('#" +
      id +
      "C').hide()})\">above</a></li><li><a href=\"#/\" onclick=\"dropDownItem('below', '#" +
      id +
      "', function(){ $('#" +
      id +
      "P').show();$('#" +
      id +
      "C').hide()})\">below</a></li><li><a href=\"#/\" onclick=\"dropDownItem('crossing', '#" +
      id +
      "', function(){ $('#" +
      id +
      "P').hide();$('#" +
      id +
      'C\').show()})">crossing</a></li></ul></div>&nbsp;<div id="' +
      id +
      'Line" class="inline"><div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'Line\')"><span class="name macd-line">signal line</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'signal line\', \'#' +
      id +
      "Line', function(){$('#" +
      id +
      "SL').show()})\">signal line</a></li><li><a href=\"#/\" onclick=\"dropDownItem('zero', '#" +
      id +
      "Line',function(){$('#" +
      id +
      'SL\').hide()})">zero</a></li></ul></div></div><div id="' +
      id +
      'SL" class="inline">&nbsp;with period <input class="period3" type="number" value="9"/> <div id="' +
      id +
      'P" class="inline"> by <input class="value" type="number" value="1" /> %</div></div><div id="' +
      id +
      'C" class="inline" style="display:none;"> from <div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'C\')"><span class="name cross-direction">bottom to top</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'bottom to top\', \'#' +
      id +
      "C')\">bottom to top</a></li><li><a href=\"#/\" onclick=\"dropDownItem('top to bottom', '#" +
      id +
      'C\')">top to bottom</a></li></ul></div></div>&nbsp;<a title="Info" onclick="macdInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a></li>'
  );
}
...
function addNewBBRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      'Line" class="inline"><div class="drop-down"><a href="#/" onclick="dropDown(\'#' +
      id +
      'Line\')"><span class="name bb-line">upper band</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'upper band\', \'#' +
      id +
      "Line', function(){})\">upper band</a></li><li><a href=\"#/\" onclick=\"dropDownItem('lower band', '#" +
      id +
      'Line\',function(){})">lower band</a></li></ul></div></div>&nbsp;of Bollinger Bands with period <input class="period" type="number" value="20" /> ' +
      '&nbsp;and Std. Dev. <input class="period2" type="number" value="2"/>&nbsp;' +
      '<div id="' +
      id +
      'P" class="inline"> by <input class="value" type="number" value="1" /> %</div>' +
      '<div id="' +
      id +
      'C" class="inline" style="display:none;"> from ' +
      '<div class="drop-down">' +
      ...
      "</div>" +
      "</div>" +
      '&nbsp;<a title="Info" onclick="bbInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function addNewStoRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      id +
      "TF')\">1 day</a></li></ul></div></div>" +
      " timeframe Stochastic %K line is " +
      '<div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      '\')"><span class="name direction">crossing</span> <span ' +
      'class="caret"></span></a>' +
      "<ul>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('above', '#" +
      id +
      ...
      '&nbsp;<div id="' +
      id +
      'D2" class="inline"> <div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      'D2\')"><span class="name direction2">below</span> <span ' +
      'class="caret"></span></a>' +
      "<ul>" +
      "<li><a href=\"#/\" onclick=\"dropDownItem('above', '#" +
      id +
      ...
      "<li><a href=\"#/\" onclick=\"dropDownItem('below', '#" +
      id +
      "D2')\">below</a></li> </ul></div></div>" +
      '</div> <input class="value" type="number" value="50" />. Setup: %K period is <input class="period" type="number" value="14" />, %D period is <input class="period2" type="number" value="3" />, Smoothing is <input class="period3" type="number" value="3" />' +
      '&nbsp;<a title="Info" onclick="stoInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function addNewStoRsiRule(id, type) {
  $("#" + type + "Rules>ul").append(
    '<li class="' +
      ...
      id +
      "TF')\">1 day</a></li></ul></div></div>" +
      " timeframe Stochastic RSI %K line is " +
      '<div class="drop-down">' +
      '<a href="#/" onclick="dropDown(\'#' +
      id +
      '\')"><span class="name direction">crossing</span> <span ' +
      ...
      id +
      "D2')\">below</a></li> </ul></div></div>" +
      '</div> <input class="value" type="number" value="50" />. Setup: RSI period is <input class="period4" type="number" value="14" />, %K period is <input class="period" type="number" value="14" />, %D period is <input class="period2" type="number" value="3" />, Smoothing is <input class="period3" type="number" value="3" />' +
      '&nbsp;<a title="Info" onclick="stoRsiInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' +
      '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' +
      id +
      '\')" href="#/"><i class="text-red fas fa-times"></i></a>' +
      "</li>"
...
function smaInfo() {
  openModalInfoBig(
    '<div style="display:inline-block;width:40%;margin:0 5%">The moving averages provide an easy way to determine the trend. It is easy to gauge the general direction and see whether a pair is trending up, trending down, or just ranging. When price action tends to stay above the moving average, it signals that price is in a general UPTREN and vise versa.<br><br>' +
      "A Simple Moving Average is calculated by adding up the last X period's closing prices and then dividing that number by X." +
      "<br><br>If you have a SMA with period 10 using daily chart, you would add up the closing prices for the last 10 days, and then divide that number by 10." +
      '<br><br>You can read on various strategies that use SMA in internet.</div><img style="display:inline-block;width:40%;margin:0 5%;vertical-align:top;" src="./assets/images/sma-info.png" alt="">'
  );
}

function emaInfo() {
  openModalInfoBig(
    '<div style="display:inline-block;width:40%;margin:0 5%">Exponential moving averages work like Simple Moving Averages, but reduce the lag by applying more weight to recent prices. ' +
      "<br><br>The weighting applied to the most recent price depends on the number of periods in the moving average. EMAs differ from simple moving averages in that a given day's EMA calculation depends on the EMA calculations for all the days prior to that day." +
      '<br><br>You can read on various strategies that use EMA in internet.</div><img style="display:inline-block;width:40%;margin:0 5%;vertical-align:top;" src="./assets/images/ema-info.png" alt="">'
  );
}

function cmaInfo() {
  openModalInfoBig(
    '<div style="display:inline-block;width:40%;margin:0 5%">A Crossover occurs when a short-term average crosses through a long-term average.' +
      "<br><br>This signal is used by traders to identify that momentum is shifting in one direction and that a strong move is likely approaching." +
      "<br><br>A buy signal is generated when the short-term average crosses above the long-term average, while a sell signal is triggered by a short-term average crossing below a long-term average." +
      '</div><img style="display:inline-block;width:40%;margin:0 5%;vertical-align:top;" src="./assets/images/cma-info.png" alt="">'
  );
}

function rsiInfo() {
  openModalInfoBig(
    '<div style="display:inline-block;width:40%;margin:0 5%">Relative Strength Index - RSI is a momentum indicator which provides a relative evaluation of the strength of the recent price performance.' +
      " RSI values range from 0 to 100. " +
      "<br><br>A RSI reading of 70 or above is commonly interpreted as indicating an overbought or overvalued condition that may signal a trend change or corrective price reversal to the downside." +
      "<br><br>A RSI reading of 30 or below is commonly interpreted as indicating an oversold or undervalued condition that may signal a trend change or corrective price reversal to the upside." +
      '</div><img style="display:inline-block;width:40%;margin:0 5%;vertical-align:top;" src="./assets/images/rsi-info.png" alt="">'
  );
}
...
function targetInfo() {
  openModalInfoBig(
    "If you provide a target the bot will place a LIMIT SELL order on the exchange to ensure the desired percent."
  );
}

function ttargetInfo() {
  openModalInfoBig(
    '<div style="display:inline-block;width:40%;margin:0 5%"><h3 class="text-center">Trailing Target</h3><br>This option will place a trailing stoploss bellow the current price after given target is reached first.<br> ' +
...
function stoplossInfo() {
  openModalInfoBig(
    "If the stoploss is reached the bot will execute a MARKET SELL order. Please note that if the bot is not running the stoploss order will not be placed! "
  );
}
...
function fillRule(rule, id) {
  let tf = rule.timeframe === null || rule.timeframe === undefined ? "Choose Timeframe" : rule.timeframe;
  $(id)
    .find(".timeframe")
    .text(tf);
  if (rule.indicator === "sma" || rule.indicator === "ema") {
    ...
    $(id)
      .find(".direction")
      .text(rule.direction === "bellow" ? "below" : rule.direction);
    if (rule.direction === "crossing") {
      $(id + "C").show();
      $(id + "P").hide();
      $(id)
        .find(".cross-direction")
        .text(rule.crossDirection);
    } else {
      $(id)
        .find(".value")
        .val(rule.value);
...
function openStrategy(strategy, hideSaveBtn) {
  try {
    ...
    if (hideSaveBtn) {
      ...
      openModalInfo(
        'The strategy "' + name + '" is currently running.<br>Please stop the execution and then try to edit.'
      );
    } else {
      $("#saveStrategyBtn").removeClass("disabled");
      $("#saveStrategyDisabled").hide();
...
async function editStrategy(name) {
  ...
  if (isUsedInExecutions && !isRunnig) {
    openModalInfo(
      'Please note that the strategy "' +
        name +
        '" is currently in the "Executions" list under the Traging tab. Your changes will apply to the execution as well.'
    );
  }
}
...
async function rmStrategy(name) {
  ...
  if (isUsedInExecutions) {
    openModalInfo(
      'The strategy "' +
        name +
        '" is in the "Executions" list under the Trades tab.<br>Please stop and remove the execution and then try to remove the strategy.'
    );
    return;
  }
    ...
    for (let strategy of strategies) {
      ...
      $("#strategiesTable tbody").append(
        "<tr><td>" +
          ...
          usedInExecution +
          '</td><td class="text-center"><a title="Edit Strategy" href="#newStrategyLabel" onclick="editStrategy(\'' +
          strategy.name.replace(/'/g, "\\'") +
          '\')" ><i class="far fa-edit"></i></a>' +
          '&nbsp;&nbsp;&nbsp;<a title="Backtest Strategy" href="#/" onclick="openBacktestStrategy(\'' +
          strategy.name.replace(/'/g, "\\'") +
          '\')" ><i class="fas fa-chart-line"></i></a>' +
          '&nbsp;&nbsp;&nbsp;<a title="Optimize Strategy" href="#/" onclick="openOptimizeStrategy(\'' +
          strategy.name.replace(/'/g, "\\'") +
          '\')" ><i class="fas fa-cogs"></i></a>' +
          '&nbsp;&nbsp;&nbsp;<a title="Remove Strategy" href="#/" onclick="rmStrategy(\'' +
          strategy.name.replace(/'/g, "\\'") +
